...
run: fmt build install local_provider force_reinit_local apply_with_logs  ## run all the targets for a fresh run or re-run (this also removes all terraform cache to ensure a fresh run every time)
